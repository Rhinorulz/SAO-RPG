...
implements SaoMob {
    ...
    public SaoZombie(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoZombie(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
    ...
    public SaoZombie(World world, MobEquipment mobEquipment) {
