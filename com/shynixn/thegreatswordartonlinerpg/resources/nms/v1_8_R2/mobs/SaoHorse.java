...
implements SaoMob {
    ...
    public SaoHorse(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoHorse(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
    ...
    public SaoHorse(World world, MobEquipment mobEquipment) {
