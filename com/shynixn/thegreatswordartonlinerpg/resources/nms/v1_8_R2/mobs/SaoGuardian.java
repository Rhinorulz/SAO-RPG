...
public final class SaoGuardian
...
implements SaoMob {
    ...
    public SaoGuardian(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoGuardian(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
    }
