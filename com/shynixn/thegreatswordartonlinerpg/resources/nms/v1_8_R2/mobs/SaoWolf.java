...
implements SaoMob {
    ...
    public SaoWolf(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoWolf(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
        MobType.enableAttackingMob((EntityCreature)this, this.goalSelector, this.targetSelector);
        this.equipment = equipment;
        this.setTamed(equipment.isDogMode());
        if (equipment.isBaby()) {
            this.setAge(-100000);
        }
    }

    public SaoWolf(World world, MobEquipment mobEquipment) {
