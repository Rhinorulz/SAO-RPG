...
implements SaoMob {
    ...
    public SaoSnowGolem(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoSnowGolem(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
        MobType.enableShootingMob((IRangedEntity)this, this.goalSelector, this.targetSelector);
        this.equipment = equipment;
    }

    public SaoSnowGolem(World world, MobEquipment mobEquipment) {
