...
implements SaoMob {
    ...
    public SaoCow(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoCow(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
    ...
    public SaoCow(World world, MobEquipment mobEquipment) {
