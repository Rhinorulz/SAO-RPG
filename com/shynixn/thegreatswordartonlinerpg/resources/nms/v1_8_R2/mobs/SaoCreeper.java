...
implements SaoMob {
    ...
    public SaoCreeper(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoCreeper(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
        this.setPowered(equipment.isPowered());
    }

    public SaoCreeper(World world, MobEquipment mobEquipment) {
