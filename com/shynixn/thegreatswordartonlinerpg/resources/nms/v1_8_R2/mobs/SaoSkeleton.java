...
implements SaoMob {
    ...
    public SaoSkeleton(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoSkeleton(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
    ...
    public SaoSkeleton(World world, MobEquipment mobEquipment) {
