...
public final class SaoCaveSpider
...
implements SaoMob {
    ...
    public SaoCaveSpider(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoCaveSpider(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
