...
implements SaoMob {
    ...
    public SaoMagmaCube(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoMagmaCube(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
    ...
    public SaoMagmaCube(World world, MobEquipment mobEquipment) {
