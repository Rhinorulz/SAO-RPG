...
implements SaoMob {
    ...
    public SaoEnderDragon(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoEnderDragon(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
    }

    public SaoEnderDragon(World world, MobEquipment mobEquipment) {
