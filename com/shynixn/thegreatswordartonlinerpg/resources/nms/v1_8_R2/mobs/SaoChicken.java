...
implements SaoMob {
    ...
    public SaoChicken(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoChicken(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
    ...
    public SaoChicken(World world, MobEquipment mobEquipment) {
