...
implements SaoMob {
    ...
    public SaoOcelot(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoOcelot(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
    ...
    public SaoOcelot(World world, MobEquipment mobEquipment) {
