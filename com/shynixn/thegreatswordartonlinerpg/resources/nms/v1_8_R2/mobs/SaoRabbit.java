...
implements SaoMob {
    ...
    public SaoRabbit(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoRabbit(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
    ...
    public SaoRabbit(World world, MobEquipment mobEquipment) {
