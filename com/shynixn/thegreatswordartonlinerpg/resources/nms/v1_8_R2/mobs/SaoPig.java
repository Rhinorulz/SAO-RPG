...
implements SaoMob {
    ...
    public SaoPig(net.minecraft.server.v1_8_R2.World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoPig(net.minecraft.server.v1_8_R2.World world, MobEquipment equipment) {
        super(world);
    ...
    public SaoPig(World world, MobEquipment mobEquipment) {
