...
implements SaoMob {
    ...
    public SaoIronGolem(World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoIronGolem(World world, MobEquipment equipment) {
        super(world);
        MobType.enableAttackingMob((EntityCreature)this, this.goalSelector, this.targetSelector);
        this.equipment = equipment;
    }

    public SaoIronGolem(org.bukkit.World world, MobEquipment mobEquipment) {
