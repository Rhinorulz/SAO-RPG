...
implements ScreenMessenger {
    ...
    public void setActionBar(Player player, String message) {
        IChatBaseComponent cbc = ChatSerializer.a((String)("{\"text\": \"" + message + "\"}"));
    ...
    public void setPlayerTitle(Player player, String title, String subtitle, int fadeIn, int stay, int fadeOut) {
        ...
        IChatBaseComponent titleJSON = ChatSerializer.a((String)("{'text': '" + ChatColor.translateAlternateColorCodes((char)'&', (String)title) + "'}"));
        IChatBaseComponent subtitleJSON = ChatSerializer.a((String)("{'text': '" + ChatColor.translateAlternateColorCodes((char)'&', (String)subtitle) + "'}"));
    ...
    public void setHeaderAndFooter(Player player, String headertext, String footertext) {
        CraftPlayer craftplayer = (CraftPlayer)player;
        PlayerConnection connection = craftplayer.getHandle().playerConnection;
        IChatBaseComponent header = ChatSerializer.a((String)("{'color': '', 'text': '" + ChatColor.translateAlternateColorCodes((char)'&', (String)headertext) + "'}"));
        IChatBaseComponent footer = ChatSerializer.a((String)("{'color': '', 'text': '" + ChatColor.translateAlternateColorCodes((char)'&', (String)footertext) + "'}"));
