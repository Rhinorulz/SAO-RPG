...
implements SaoMob {
    ...
    public SaoEndermite(World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoEndermite(World world, MobEquipment equipment) {
        super(world);
        MobType.enableAttackingMob((EntityCreature)this, this.goalSelector, this.targetSelector);
        this.equipment = equipment;
    }

    public SaoEndermite(org.bukkit.World world, MobEquipment mobEquipment) {
