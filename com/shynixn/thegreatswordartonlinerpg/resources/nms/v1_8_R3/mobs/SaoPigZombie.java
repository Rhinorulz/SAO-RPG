...
implements SaoMob {
    ...
    public SaoPigZombie(World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoPigZombie(World world, MobEquipment equipment) {
        super(world);
    ...
    public SaoPigZombie(org.bukkit.World world, MobEquipment mobEquipment) {
