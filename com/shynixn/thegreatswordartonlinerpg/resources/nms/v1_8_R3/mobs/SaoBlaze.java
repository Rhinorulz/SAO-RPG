 ...
 *  net.minecraft.server.v1_8_R3.ControllerLook
 *  net.minecraft.server.v1_8_R3.ControllerMove
 ...
 *  net.minecraft.server.v1_8_R3.EntitySmallFireball
...
implements SaoMob {
    ...
    extends PathfinderGoal {
        ...
        public void e() {
            --this.c;
            EntityLiving localEntityLiving = this.a.getGoalTarget();
            double d1 = this.a.h((net.minecraft.server.v1_8_R3.Entity)localEntityLiving);
            if (d1 < 4.0) {
                if (this.c <= 0) {
                    this.c = 20;
                    this.a.r((net.minecraft.server.v1_8_R3.Entity)localEntityLiving);
                }
                ...
                if (this.c <= 0) {
                    ...
                    if (this.b > 1) {
                        ...
                        while (i < 1) {
                            ...
                            this.a.world.addEntity((net.minecraft.server.v1_8_R3.Entity)localEntitySmallFireball);
                            ++i;
                        }
                    }
                }
                this.a.getControllerLook().a((net.minecraft.server.v1_8_R3.Entity)localEntityLiving, 10.0f, 10.0f);
            } else {
