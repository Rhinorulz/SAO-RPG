...
public class MobExtender {
    public static void spawn(EntityInsentient entity, Location location) {
        ...
        mcWorld.addEntity((net.minecraft.server.v1_8_R3.Entity)entity, CreatureSpawnEvent.SpawnReason.CUSTOM);
    }

    public static void attackPassive(EntityCreature damager, net.minecraft.server.v1_8_R3.Entity damaged, MobEquipment equipment) {
    ...
    public static void attackAggresive(EntityCreature damager, net.minecraft.server.v1_8_R3.Entity damaged, MobEquipment equipment) {
        MobMoves.kickEntity((Entity)damaged.getBukkitEntity(), (Entity)damager.getBukkitEntity(), equipment);
        damaged.setOnFire(equipment.getFireTime());
    }

    public static void attackSlime(EntityInsentient damager, net.minecraft.server.v1_8_R3.Entity damaged, MobEquipment equipment) {
