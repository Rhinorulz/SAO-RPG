...
implements SaoMob {
    ...
    public SaoMushroomCow(World world) {
        super(world);
        this.isSpecial = false;
    }

    public SaoMushroomCow(World world, MobEquipment equipment) {
        super(world);
    ...
    public SaoMushroomCow(org.bukkit.World world, MobEquipment mobEquipment) {
